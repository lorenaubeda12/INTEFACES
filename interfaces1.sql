...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2022 a las 16:30:46
...
INSERT INTO `menu` (`idMenu`, `nombreMenu`, `posicionMenu`, `acceso`) VALUES
(1, 'Home', 0, 'P'),
(2, 'Mantenimiento', 0, 'NP'),
(3, 'Prueba', 0, 'P'),
(4, 'Precios', 0, 'NP'),
(5, 'Gestion Usuarios', 2, 'NP'),
(6, 'Menu', 2, 'NP'),
(7, 'Prueba2', 3, 'P');
...
(1, 'lorena', 'Blasco', 'Ubeda', 'M', '2020-10-01', 'lorenaubeda12@gmial.com', '976466599', 'lorena12', '202cb962ac59075b964b07152d234b70', 'S'),
